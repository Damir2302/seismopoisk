$(document).ready(function() {
  ...
  function afterReveal(el) {
      el.addEventListener('animationend', function(event) {
        if (el.classList.contains('services-l__block') && el.id == 'bx_3218110189_139') {
          $('.services-l__block-bg img').removeClass('after-reveal');
        }

        if (el.classList.contains('partners__tile') && el.id == 'bx_3485106786_40') {
          $('.partners-bg').removeClass('after-reveal')
        }
      });
  }
